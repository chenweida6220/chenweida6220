...
dwg.add(dwg.rect(insert=(0, 0), size=('100%', '100%'), fill=BG_COLOR, rx=8, ry=8,stroke=TEXT_COLOR, stroke_width=OUTLINE_THICKNESS))

# --- Top bar ---
dwg.add(dwg.rect(insert=(OUTLINE_THICKNESS, OUTLINE_THICKNESS), size=(SVG_WIDTH - OUTLINE_THICKNESS - 1, '20px'), rx=8, ry=8,fill=TERMINAL_HEADER))
dwg.add(dwg.text("🔴🟡🟢",
                 insert=(800 - RIGHT_PADDING, 15),
                 text_anchor="end",
                 font_size="14px", 
                 font_family=FONT))
dwg.add(dwg.text("chenweida6220@github: ~", 
                 insert=(LEFT_PADDING, 15),
                 fill=TEXT_COLOR, 
                 font_size="14px", 
                 font_family=FONT))
...
image_path = "Portfolio Items/dark-mode_headshot-ascii-art (2).png"  
